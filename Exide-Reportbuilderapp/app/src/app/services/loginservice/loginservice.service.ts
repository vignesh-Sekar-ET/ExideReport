...
export class loginserviceService {
    ...
    LoginSubmit(uname:any,pass1:any): Observable<any> {
        ...
        let username = "'" + uname + "'";
        let password = "'" + pass1 + "'";
        /*  let headers = new HttpHeaders().set('Content-Type', 'application/json').set('token', this.sessions.getValue('accessToken')); */
        url += "getlogindetails?name="+username+"&&pass="+password;
