...
export class logintestservice {
  ...
  //   service flows_logintestservice

  public async getlogin(...others) {
    try {
      let bh = { input: {}, local: { result: undefined, apiurl: undefined } };
      bh = this.__constructDefault(bh);

      bh = await this.sd_Er2qQYqxFRzbq73j(bh);
      //appendnew_next_getlogin
  ...
  //appendnew_flow_logintestservice_Start

  async sd_Er2qQYqxFRzbq73j(bh) {
    try {
      bh.local.apiurl = 'SELECT * FROM sampledata ';

      bh = await this.sd_Hjfz8snACeQvBu4g(bh);
      //appendnew_next_sd_Er2qQYqxFRzbq73j
      return bh;
    } catch (e) {
      throw e;
    }
  }
  async sd_Hjfz8snACeQvBu4g(bh) {
    try {
      let requestOptions = {
        url: bh.local.apiurl,
        method: 'get',
      ...
      //appendnew_next_sd_Hjfz8snACeQvBu4g
      return bh;
    } catch (e) {
      throw e;
    }
