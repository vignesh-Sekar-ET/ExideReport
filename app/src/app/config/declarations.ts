...
children: []},{path: 'dbconfiglist', component: dbconfiglistComponent},{path: 'dbconfigCreate', component: dbconfigcreateComponent},{path: 'usergroupmappinglist', component: usergrouplistComponent}]},{path: '', redirectTo: 'login', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
